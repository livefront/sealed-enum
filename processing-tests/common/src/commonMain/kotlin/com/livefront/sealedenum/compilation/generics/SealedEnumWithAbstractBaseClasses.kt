...
public interface BaseClassInterface1<T>

public interface BaseClassInterface2<T>

public interface BaseClassInterface3<out T>

@Suppress("UnnecessaryAbstractClass")
public abstract class AlphaBase<A> : BaseClassInterface1<A>

@Suppress("UnnecessaryAbstractClass")
public abstract class BetaBase<A, B : Any> : AlphaBase<BaseClassInterface1<A>>(), BaseClassInterface2<B>

public sealed class SealedEnumWithAbstractBaseClasses : BetaBase<Any?, String>() {
    @GenSealedEnum(generateEnum = true)
    public companion object
}

@Suppress("MaxLineLength")
public val sealedEnumWithAbstractBaseClassesGenerated: String = """
package com.livefront.sealedenum.compilation.generics
...
@Suppress("UnnecessaryAbstractClass")
public abstract class GammaBase

@Suppress("UnnecessaryAbstractClass")
public abstract class DeltaBase<out T : Any> : GammaBase(), BaseClassInterface3<BaseClassInterface3<T>>

public sealed class SealedEnumWithAbstractBaseClassesCovariantType<out T : Any> : DeltaBase<T>() {
    @GenSealedEnum(generateEnum = true)
    public companion object
}

@Suppress("MaxLineLength")
public val sealedEnumWithAbstractBaseClassesCovariantTypeGenerated: String = """
package com.livefront.sealedenum.compilation.generics
