...
By applying `@GenSealedEnum` to a sealed class with only objects, an object implementing [`SealedEnum`](sealedenum/src/main/kotlin/com/livefront/sealedenum/SealedEnum.kt) for that sealed class will be generated.
