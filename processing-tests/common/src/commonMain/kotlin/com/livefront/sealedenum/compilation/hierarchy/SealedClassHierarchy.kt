...
public class FirstClassHierarchy {
...
public val firstClassHierarchyAGenerated: String = """
package com.livefront.sealedenum.compilation.hierarchy
...
public val firstClassHierarchyBGenerated: String = """
package com.livefront.sealedenum.compilation.hierarchy
...
public class SecondClassHierarchy {
    ...
    public sealed class Z {
        ...
        public sealed class X : Z() {

            public object W : X()

            public object V : X()

            public sealed class U : X() {
                public object T : U()
