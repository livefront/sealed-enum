...
enum class EnvironmentsEnum(
    ...
    Environments_Http_Livefront(com.livefront.sealedenum.Environments.Http.Livefront),

    Environments_Http_Google(com.livefront.sealedenum.Environments.Http.Google),

    Environments_Https_Livefront(com.livefront.sealedenum.Environments.Https.Livefront),

    Environments_Https_Google(com.livefront.sealedenum.Environments.Https.Google)
}
