...
class JavaBaseClassesTests {
    ...
    fun `compilation generates correct code`() {
        val result = compile(
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaInterface1.java").toFile()
            ),
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaInterface2.java").toFile()
            ),
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaInterface3.java").toFile()
            ),
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaInterface4.java").toFile()
            ),
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaInterface5.java").toFile()
            ),
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaFirstBaseClass.java").toFile()
            ),
            SourceFile.fromPath(
                Paths.get("src", "test", "java", "com", "livefront", "sealedenum", "JavaSecondBaseClass.java").toFile()
            ),
            getSourceFile("JavaBaseClasses.kt")
        )
