...
public interface KotlinInterface1

public interface KotlinInterface2<T>

public interface KotlinInterface3<out T>
...
public interface KotlinInterface7<out T>

public open class KotlinFirstBaseClass<out C : Collection<String>> :
    KotlinInterface1, KotlinInterface3<C>, JavaInterface4

public open class KotlinSecondBaseClass<A, B, C : Collection<String>, D> :
...
public sealed class JavaBaseClassesSealedClass<out A : Collection<Int>> :
    JavaSecondBaseClass<Int, String, List<String>>(), KotlinInterface7<A> {

    public object FirstObject : JavaBaseClassesSealedClass<List<Int>>()

    public object SecondObject : JavaBaseClassesSealedClass<Set<Int>>()
...
@Language("kotlin")
public val javaBaseClassesSealedClassGenerated: String = """
package com.livefront.sealedenum.compilation.kitchensink
