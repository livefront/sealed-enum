...
public sealed class PrivateInterfaceSealedClass :
    JavaPrivateInterfaceSubclass(JavaPrivateInterfaceOuterClass()), PrivateInterface {

    public object FirstObject : PrivateInterfaceSealedClass()

    public object SecondObject : PrivateInterfaceSealedClass()
...
@Language("kotlin")
public val privateInterfaceSealedClassGenerated: String = """
package com.livefront.sealedenum.compilation.visibility
