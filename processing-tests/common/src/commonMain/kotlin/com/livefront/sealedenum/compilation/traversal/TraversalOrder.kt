...
public sealed class Tree {
    ...
    public object A : Tree()

    public sealed class B : Tree() {
    ...
    public object K : Tree()

    public sealed class L : Tree() {

        public sealed class M : L() {
...
public val treeGenerated: String = """
package com.livefront.sealedenum.compilation.traversal
