...
import com.livefront.sealedenum.compilation.visibility.ProtectedInterfaceOuterClass.ProtectedInterfaceSealedClass
...
class NonVisibleInterfacesTests {
    ...
    inner class PrivateInterfaceSealedClassTests {
        ...
        fun `compilation generates correct code`() {
            val result = compile(
                getSourceFile("compilation", "visibility", "NonVisibleInterfaces.kt")
            )
